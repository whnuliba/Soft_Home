...
public class WorkflowMainTableInfo  implements java.io.Serializable {
    private weaver.workflow.webservices.WorkflowRequestTableRecord[] requestRecords;
    ...
    public WorkflowMainTableInfo(
           weaver.workflow.webservices.WorkflowRequestTableRecord[] requestRecords,
     ...
     */
    public weaver.workflow.webservices.WorkflowRequestTableRecord[] getRequestRecords() {
        return requestRecords;
    }
     ...
     */
    public void setRequestRecords(weaver.workflow.webservices.WorkflowRequestTableRecord[] requestRecords) {
        this.requestRecords = requestRecords;
    }
